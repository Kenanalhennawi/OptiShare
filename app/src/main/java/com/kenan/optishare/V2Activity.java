...
public class V2Activity extends ComponentActivity implements
    ...
    private void showHome() {
        ...
        LinearLayout.LayoutParams sendLp = new LinearLayout.LayoutParams(0,dp(158),1);
    ...
    private LinearLayout categoryRow(Button a,Button b,Button c){LinearLayout row=new LinearLayout(this);row.setOrientation(LinearLayout.HORIZONTAL);LinearLayout.LayoutParams p1=new LinearLayout.LayoutParams(0,dp(124),1);p1.setMargins(dp(6),0,dp(6),0);row.addView(a,p1);LinearLayout.LayoutParams p2=new LinearLayout.LayoutParams(0,dp(124),1);p2.setMargins(dp(6),0,dp(6),0);row.addView(b,p2);LinearLayout.LayoutParams p3=new LinearLayout.LayoutParams(0,dp(124),1);p3.setMargins(dp(6),0,dp(6),0);row.addView(c,p3);return row;}
