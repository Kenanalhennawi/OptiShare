...
public class V2Activity extends ComponentActivity implements
    ...
    private void showHome() {
        ...
        LinearLayout.LayoutParams sendLp = new LinearLayout.LayoutParams(0,dp(138),1);
        sendLp.setMargins(dp(6),0,dp(6),0);
        actions.addView(send,sendLp);
        LinearLayout.LayoutParams receiveLp = new LinearLayout.LayoutParams(0,dp(138),1);
