...
public class V2Activity extends ComponentActivity implements
    ...
    private Button category(int icon,String label,int color,View.OnClickListener listener){Button b=new Button(this);b.setAllCaps(false);b.setText(UiText.get(this,label));b.setTextColor(Color.WHITE);b.setTextSize(14);b.setTypeface(Typeface.DEFAULT_BOLD);b.setGravity(Gravity.CENTER);b.setCompoundDrawables(null,circularIcon(icon,color,50),null,null);b.setCompoundDrawablePadding(dp(11));b.setPadding(dp(8),dp(13),dp(8),dp(12));b.setLetterSpacing(.015f);b.setBackground(vividGradient(new int[]{shine(color),lighten(color),color,darken(color)},28,Color.argb(130,255,255,255)));if(Build.VERSION.SDK_INT>=21){b.setElevation(dp(18));b.setTranslationZ(dp(5));}applyPressMotion(b);b.setOnClickListener(listener);return b;}
