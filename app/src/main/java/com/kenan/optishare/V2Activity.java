...
public class V2Activity extends ComponentActivity implements
    ...
    /** Public Android 1.0.1 release identity. */
        ...
        @Override public void onReceive(Context context, Intent intent) {
            ...
            if (WifiP2pManager.WIFI_P2P_CONNECTION_CHANGED_ACTION.equals(action)) {
                ...
                if (info != null && info.isConnected()) {
                    ...
                    // Wi-Fi Direct can report a disconnected group after an active transfer has
                    // already fallen back to LAN. TransferService owns connection state here.
                    return;
    ...
    private String appVersion(){try{return getPackageManager().getPackageInfo(getPackageName(),0).versionName;}catch(Exception ignored){return "1.0.1";}}
